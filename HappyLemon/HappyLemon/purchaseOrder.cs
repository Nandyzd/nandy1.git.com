...
namespace HappyLemon
{
    public partial class purchaseOrder : Form
    {
        ...
        //public rawMaterial r = new rawMaterial();
        ...
        private void 购货_Opening(object sender, CancelEventArgs e)
        {
            MessageBox.Show("fg");
        }
        ...
        private void 购货退货单ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                ps = p.selectMaterial_danhao(dataGridView2.Rows[r].Cells[1].Value.ToString(), 0);
        ...
        private void search_history_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (textBox2.Text=="")
                {
                    ...
                    dt.Columns.Add("备注", typeof(String));
                    ps = p.selectdate(Convert.ToDateTime(dateTimePicker2.Text), Convert.ToDateTime(dateTimePicker3.Text),0);
                ...
                else
                {
                    ...
                    dt.Columns.Add("操作人", typeof(String));
                    dt.Columns.Add("备注", typeof(String));
                    ps = p.selectdateAndNum_Supp(textBox2.Text,0);
                    foreach (purchaseDanju p1 in ps)
                    {
                        employ e1 = new employ();
                        employeedao edao = new employeedao();
